...
This installation is a fork with customized skills. Before filing
upstream, check whether the finding cites a skill line that differs from
`obra/superpowers`. If it does, the problem belongs to the fork: tell your
partner and do not file on `obra/superpowers`.
