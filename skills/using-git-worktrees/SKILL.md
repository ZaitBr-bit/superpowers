...
Run lightweight readiness checks to ensure worktree starts clean:
...
### Proceeding with failing readiness checks

- **Problem:** Can't distinguish new issues from pre-existing readiness gaps
...
[Run npm install]
[Run lightweight readiness checks]

Worktree ready at /Users/jesse/myproject/.worktrees/auth
Readiness checks passed (0 issues)
