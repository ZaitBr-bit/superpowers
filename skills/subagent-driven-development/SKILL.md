...
**Waiting on dispatched subagents:** never poll. The harness notifies you
when a child finishes. While you wait, keep doing local work — ledger
updates, packaging the next review, reading reports.
