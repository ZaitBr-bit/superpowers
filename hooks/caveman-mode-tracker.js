...
// Rastreia qual modo caveman está ativo via flag file.
// Intercepta /caveman-stats e retorna estatísticas diretamente (decision: block).
...
// Modos com comportamento próprio — não são níveis de intensidade caveman.
...
process.stdin.on('end', () => {
  try {
    ...
    // Natural language activation ("talk like caveman", "use caveman mode", etc.)
    if (
    ...
    // /caveman-stats [--share] — intercepta o prompt e retorna estatísticas.
    ...
    // Desativação por linguagem natural
    if (
    ...
    // Reforço por turno: injeta lembrete compacto quando caveman está ativo.
    // Modos independentes têm comportamento próprio — não usar o reforço base.
