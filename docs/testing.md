...
- `tests/repository-coherence/` — cross-platform checks for removed-feature
  references, broken active skill links, manifest targets, and unreferenced
  supplemental skill files. Run with `npm run test:coherence`.
